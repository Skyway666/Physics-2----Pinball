...
// Blit to screen
bool ModuleRender::Blit(SDL_Texture* texture, int x, int y, float scale, SDL_Rect* section, float speed, double angle, bool flip, int pivot_x, int pivot_y, int w, int h)
{
	bool ret = true;
	SDL_Rect rect;
